...
#else
    static const wchar_t* Whitelisted[] = { {L"conhost.exe"}, {L"ProcessLasso.exe"}, {L"powershell.exe"} }; //non-console version of this project will be different and conhost should not be considered whitelisted 
#endif
}
