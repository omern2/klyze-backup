...
{
    /// <summary>
    /// Google OAuth 2.0 flow for desktop apps.
    /// Local HTTP listener ile tarayıcıdan auth code'u yakalar,
    /// Google token'la değiştirir, Firebase signInWithIdp ile giriş yapar.
    /// </summary>
    public class GoogleAuthService
    {
        private readonly HttpClient _http;

        // Google OAuth credentials — Firebase Console'dan alınır
        ...
        /// <summary>
        /// Firebase RTDB'den Google OAuth credentials'ları yükler.
        /// </summary>
        ...
        /// <summary>
        /// Google OAuth flow'unu başlatır. Tarayıcıyı açar, auth code'u yakalar,
        /// Google token alır, Firebase ile giriş yapar.
        /// </summary>
        public async Task<GoogleSignInResult> SignInAsync(CancellationToken ct = default)
        {
            ...
            // Auth code'u Google token'la değiştir
